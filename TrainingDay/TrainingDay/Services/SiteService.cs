...
namespace TrainingDay.Services
{
    ...
    public class SiteService
    {
        ...
        private static string _alarmEditUrl = domain + @"/MobileAlarms/{id}";
        private static string _alarmCreateUrl = domain + @"/MobileAlarms";
        private static string _alarmDeleteUrl = domain + @"/MobileAlarms/{id}";
        /// <summary>
        /// Create alarm
        /// </summary>
        ...
        public static async Task<int> UpdateAlarm(Alarm alarm)
        {
            try
            {
                var client = new RestClient(_alarmEditUrl);
                client.Timeout = -1;
