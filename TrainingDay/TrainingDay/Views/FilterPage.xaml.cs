...
namespace TrainingDay.Old
{
    ...
    public partial class FilterPage : ContentPage
    {
        ...
        protected override void OnAppearing()
        {
            ...
            {
                skiaView.WidthRequest = MuscleImage.Width;
                skiaView.HeightRequest = MuscleImage.Width / (496.0 / 514.0);
                skiaView.Margin = new Thickness(0, (MuscleImage.Height - skiaView.HeightRequest)/2);
            }
        }
